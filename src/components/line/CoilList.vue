...
export default {
    ...
    methods: {
        // 전체조회 버튼 클릭 - emit으로 상위vue인 Line.vue로 넘기는 역할
        handleAll(){
            // 최소 실행시 선 클릭시 걸리는 버그
...
div{ font-size: 12px; }
input{ padding: 0px; }
.tabulator .tabulator-header .tabulator-col .tabulator-col-content{ padding: 0px;}
/*Theme the header*/
...
.table-responsive{ overflow: visible; width: 100%; margin-left: 0px; }
