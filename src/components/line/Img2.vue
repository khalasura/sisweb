...
<div>
    <div style="width: 260px; height: 460px;">
        ...
        <div v-if="this.$store.state.defectImage2 == null" style="text-align:center; width: 300px; height: 450px;">
...
export default {
    ...
    methods: {
        ...
        handleDraw(scale, translatePos, flag){
            var data = this.$store.state.coildefect2;
            if (data == null) return;
            if(this.$store.state.defectImage2 == null) {
                // 캔바스
                var canvas = this.$refs.device;
            ...
            var src = "data:image/png;base64," + this.$store.state.defectImage2;
    ...
    computed: {
        imgsrc: function() {
            return this.$store.state.defectImage2
        },
        btndisabled: function() {
            return this.$store.state.detailbtnclick2
        },
        HeightSize: function() {
